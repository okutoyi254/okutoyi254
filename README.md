...
A university-scale system for automated attendance:
- Facial recognition for attendance
- JWT authentication with role-based access
- Real-time WebSocket updates
- Designed for scalability and automation in educational institutions

[GitHub Repo](https://github.com/okutoyi254/smart-classroom-attendance)

---

### Distributed Kafka Order Processing
**Tech:** Java, Spring Boot, Apache Kafka  

A distributed, event-driven backend system simulating real enterprise processing:
- Kafka-based asynchronous communication
- Fault-tolerant microservices architecture
- Demonstrates scalable, reliable backend patterns

[GitHub Repo](https://github.com/okutoyi254/distributed-kafka-order-processing)
...
> "Building reliable backend systems and solving real-world problems is my passion. I thrive in creating scalable, maintainable, and impactful software."
